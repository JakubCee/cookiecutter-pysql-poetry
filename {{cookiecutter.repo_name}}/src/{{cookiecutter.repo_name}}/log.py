...
from {{ cookiecutter.repo_name }}.__init__ import ( 
    __appname__,
    __version__,
)
...
def get_loguru(
    ...
    logger.remove()
    logger.add(
        sys.stderr, level="TRACE", format=console_fmt
    )  # TODO: Set to DEBUG or INFO in production
...
logger = get_loguru(
    app_name=__appname__, version=__version__, file_logs_folder=r"\\MSTM1BDB33\Apps\__LOGS"
)
